                          ...
                          if(ResultCode==330008)//此代码代表需要输入密码
                           {
                               ...
                               if (frmbalancepwd.DialogResult == DialogResult.OK)
                               {
                                   ...
                                   string privatekey = MainModel.URL.Contains("pos.qdama.cn") ? "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJwAr8nfsmnOswIuQdY5hrs88aSgIKNBiyCYpgBKDX5+QYh90vG0e5iHxC0u9srRRFlpfMfDpPvQQRHADeCi6l8CAwEAAQ==" : "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAN2nINiXBXIzzC6LMqS7/cyXLtEpqa+e2WcyHQoyXytWabBNRH8Vno/d/sDXCZm81LIJJwralJHYUciMMTEkqeMCAwEAAQ==";
