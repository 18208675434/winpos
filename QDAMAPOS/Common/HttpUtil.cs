    ...
    public class HttpUtil
    {
        ...
        public userModel GetUser(ref string errormsg)
        {
            try
            {
                ...
                {
                    try { LogManager.WriteLog("Error", "user:" + json); }
                    catch { }
                    errormsg = rd.message;
                    return null;
                }
        ...
        public string GetTVshowpageForPromotion(ref string erromessage)
        {
            try
            {
                ...
                {
                    try { LogManager.WriteLog("Error", "gettvshowpageforpromotion:" + json); }
                    catch { }
                    erromessage = rd.message;
                    return null;
                }
        ...
        public string GetTVshowpageForPork(ref string erromessage)
        {
            try
            {
                ...
                {
                    try { LogManager.WriteLog("Error", "gettvshowpageforpork:" + json); }
                    catch { }
                    erromessage = rd.message;
                    return null;
                }
        ...
        public PosActivesSku GetActiveSkus(ref string erromessage)
        {
            try
            {
               ...
               // return json;
                ...
                {
                    try { LogManager.WriteLog("Error", "getactiveskus:" + json); }
                    catch { }
                    erromessage = rd.message;
                    return null;
                }
        ...
        public PosActivesSku GetPromotionSkus(ref string erromessage)
        {
            try
            {
                ...
                {
                    try { LogManager.WriteLog("Error", "getpromotionskus:" + json); }
                    catch { }
                    erromessage = rd.message;
                    return null;
                }
        ...
        public bool CreateOffLineOrder(OffLineOrder offlineorder, ref string errormsg)
        {
            try
            {
                ...
                string testjson = JsonConvert.SerializeObject(offlineorder);
