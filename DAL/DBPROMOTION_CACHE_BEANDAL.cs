    ...
    public class DBPROMOTION_CACHE_BEANDAL
    {
        ...
        public int Add(Maticsoft.Model.DBPROMOTION_CACHE_BEANMODEL model)
        {
            ...
            SQLiteParameter[] parameters = {
					...
					new SQLiteParameter("@RANK", DbType.Int64,16),
					...
					new SQLiteParameter("@CANBECOMBINED", DbType.Int64,16),
					new SQLiteParameter("@ENABLED", DbType.Int64,16),
					new SQLiteParameter("@SALECHANNEL", DbType.Int64,16),
					new SQLiteParameter("@ENABLEDFROM", DbType.Int64,16),
					new SQLiteParameter("@ENABLEDTO", DbType.Int64,16),
					new SQLiteParameter("@ENABLEDTIMEINFO", DbType.String),
					new SQLiteParameter("@CREATEDAT", DbType.Int64,16),
					new SQLiteParameter("@UPDATEDAT", DbType.Int64,16),
					new SQLiteParameter("@CREATEDBY", DbType.String),
					new SQLiteParameter("@UPDATEDBY", DbType.String),
					new SQLiteParameter("@FROMOUTER", DbType.Int64,16),
					...
					new SQLiteParameter("@CANMIXCOUPON", DbType.Int64,16),
					new SQLiteParameter("@ORDERSUBTYPE", DbType.Int64,16),
					...
					new SQLiteParameter("@ONLYUSEINORIGINAL", DbType.Int64,16),
					new SQLiteParameter("@ONLYMEMBER", DbType.Int64,16),
					new SQLiteParameter("@MEMBERTAGS", DbType.String),
					new SQLiteParameter("@PURCHASELIMIT", DbType.Int64,16),
					new SQLiteParameter("@MEMBERFLAG", DbType.Int64,16)};
        ...
        public bool Update(Maticsoft.Model.DBPROMOTION_CACHE_BEANMODEL model)
        {
            ...
            SQLiteParameter[] parameters = {
					...
					new SQLiteParameter("@PURCHASELIMIT", DbType.Int64,16),
					new SQLiteParameter("@MEMBERFLAG", DbType.Int64,16),
					new SQLiteParameter("@_id", DbType.Int64,16)};
            parameters[0].Value = model.CODE;
            parameters[1].Value = model.RANK;
            parameters[2].Value = model.TENANTSCOPE;
            parameters[3].Value = model.DISTRICTSCOPE;
