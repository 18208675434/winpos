...
namespace WinSaasPOS_Scale.Model.Promotion
{
    public class MoneyUtils
    {
        ...
        public static Decimal add( Decimal first,  Decimal second) {
            return Math.Round(first + second, CommonConstant.DEFAULT_SCALE, MidpointRounding.AwayFromZero); 
        }
        ...
        public static Decimal add( Decimal first,  Decimal second, int defaultScale) {
            if (first == null || first.Equals(Decimal.Zero)) {
                ...
                //}
                return Math.Round(first + second, CommonConstant.DEFAULT_SCALE, MidpointRounding.AwayFromZero); //first.add(second).setScale(getSafeScale(defaultScale), CommonConstant.DEFAULT_ROUND);
            }
        }
        ...
        public static Decimal substract(Decimal first, Decimal second, int defaultScale)
        {
            ...
            //}
            return Math.Round(first - second, CommonConstant.DEFAULT_ROUND, MidpointRounding.AwayFromZero); //first.subtract(second).setScale(getSafeScale(defaultScale), CommonConstant.DEFAULT_ROUND);
        }
        ...
        public static Decimal multiply(Decimal first, Decimal second, int defaultScale)
        {
            ...
            return Math.Round(first * second, 2, MidpointRounding.AwayFromZero);
        ...
        public static Decimal divide(Decimal first, Decimal second, int defaultScale){
            ...
            return Math.Round(first / second, getSafeScale(defaultScale), MidpointRounding.AwayFromZero);
