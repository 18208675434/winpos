...
namespace Maticsoft.BLL
{
	...
	/// JSON_BEAN
	/// </summary>
	public partial class JSON_BEANBLL
	{
		private readonly Maticsoft.DAL.JSON_BEANDAL dal=new Maticsoft.DAL.JSON_BEANDAL();
		public JSON_BEANBLL()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Maticsoft.Model.JSON_BEAN GetModelByCache(int _id)
        //{
			
        //    string CacheKey = "JSON_BEANModel-" + _id;
        ...
        //        catch{}
        //    }
        //    return (Maticsoft.Model.JSON_BEAN)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.JSON_BEANMODEL> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.JSON_BEANMODEL> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.JSON_BEANMODEL> modelList = new List<Maticsoft.Model.JSON_BEANMODEL>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.JSON_BEANMODEL model;
