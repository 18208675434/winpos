...
namespace Maticsoft.BLL
{
	...
	public partial class DBRECEIPT_BEANBLL
	{
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Maticsoft.Model.DBRECEIPT_BEAN GetModelByCache(int _id)
        //{
			
        //    string CacheKey = "DBRECEIPT_BEANModel-" + _id;
        ...
        //        catch{}
        //    }
        //    return (Maticsoft.Model.DBRECEIPT_BEAN)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.DBRECEIPT_BEANMODEL> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.DBRECEIPT_BEANMODEL> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.DBRECEIPT_BEANMODEL> modelList = new List<Maticsoft.Model.DBRECEIPT_BEANMODEL>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.DBRECEIPT_BEANMODEL model;
