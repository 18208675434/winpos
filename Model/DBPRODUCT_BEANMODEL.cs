...
namespace Maticsoft.Model
{
	...
	public partial class DBPRODUCT_BEANMODEL
	{
		...
		private int _panelshowflag;
		private string _mainimg;
		private int _status;
		private int _special_status;
		private int _is_query_barcode;
		/// <summary>
		/// 
		/// </summary>
		public int _id
