...
namespace WinSaasPOS.MyControl
{
    public partial class RoundPanel : System.Windows.Forms.UserControl
    {
        public RoundPanel()
        {
            InitializeComponent();
        ...
        private void RoundPanel_Resize(object sender, EventArgs e)
        {
           // SetWindowRegion();
        }
