...
//    SHIPPING("S", "运费优惠（无券）"),
//    ITEM("I", "单品优惠"),
//    ORDERCOUPON("OrderCoupon", "整单券"),
//    FREIGHTFREECOUPON("FreightFreeCoupon", "免邮券");

    //订单优惠（无券）
    public static String ORDER = "O";
    //运费优惠（无券）
    public static String SHIPPING = "S";
    //单品优惠
    public static String ITEM = "I";
    //折扣
    public static String DISCOUNT = "discount";
    //整单券
    public static String ORDERCOUPON = "OrderCoupon";
    //免邮券
    public static String FREIGHTFREECOUPON = "FreightFreeCoupon";
...
//    PACKAGE_SELLING("package.selling", "N元N件");
    ...
    //清仓
    public static String PACKAGE_CLEARANCE_SELLING = "clearance.selling";
    //组合折扣
    public static String PACKAGE_COMBINED_SELLING = "combined.selling";
    ...
    public static  long MEMBER_GRADE_DISCOUNT_PROMO_ID = 2019000000003L;
