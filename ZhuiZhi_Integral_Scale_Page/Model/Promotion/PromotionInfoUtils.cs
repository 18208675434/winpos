...
{public class PromotionInfoUtils {
    ...
    public static void sortPromotion(List<DBPROMOTION_CACHE_BEANMODEL> list) {
            ...
            list.Sort((o1, o2) => {
                if (o1.PROMOACTION.Equals(EnumPromotionType.PACKAGE_CLEARANCE_SELLING) &&
                        !o2.PROMOACTION.Equals(EnumPromotionType.PACKAGE_CLEARANCE_SELLING))
                {
                    return -1;
                }
                if (!o1.PROMOACTION.Equals(EnumPromotionType.PACKAGE_CLEARANCE_SELLING) &&
                ...
                if (o1.FROMOUTER.Equals(o2.FROMOUTER))
                {
                    if (o2.RANK.Equals(o1.RANK))
                    {//优先级相同,按时间排序
