...
{
    public partial class FormTopUpByCash : Form
    {
        ...
        public FormTopUpByCash(decimal topupquantity)
        {
            ...
            try
            {
                TopUpAmount = topupquantity;

                lblPrice.Text = "￥" + topupquantity.ToString("f2");
                txtCash.Text = topupquantity.ToString("f2");
                txtCash.Focus();
            }
            catch { }
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    if (doublenum<TopUpAmount)
                    {
                        MainModel.ShowLog("支付金额不能小于充值金额", false);
                        return;
                    }
                    else if (doublenum == TopUpAmount)
                    {
                        ...
                        FormPayCashToChange frmpaycashtochange = new FormPayCashToChange(TopUpAmount,doublenum);
