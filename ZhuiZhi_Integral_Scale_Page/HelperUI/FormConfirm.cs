...
namespace ZhuiZhi_Integral_Scale_UncleFruit.HelperUI
{
    public partial class FormConfirm : Form
    {
        ...
        private void FormConfirm_Activated(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrEmpty(lblMsg.Text))
                {
                    lbtnCancle.Top = lblTitle.Bottom + 30;

                    lbtnOK.Top = lblTitle.Bottom + 30;

                    this.Size = new Size(this.Width,lbtnOK.Bottom+20);
                }
                else
                {
                    lbtnCancle.Top = lblMsg.Bottom + 30;

                    lbtnOK.Top = lblMsg.Bottom + 30;
