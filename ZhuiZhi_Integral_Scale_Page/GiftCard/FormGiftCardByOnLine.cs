...
{
    public partial class FormGiftCardByOnLine : Form
    {
        ...
        public FormGiftCardByOnLine(string orderid)
        {
            InitializeComponent();
        ...
        private void lblExit_Click(object sender, EventArgs e)
        {
            ...
            string errormsg = "";
            bool result = gifthttp.CancelCardOrder(CurrentOrderID, ref errormsg);
